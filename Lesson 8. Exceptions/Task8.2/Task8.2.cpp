...
int main()
{
    ...
    try {
        ...
        RightAngledTriangle right_angled_triangle(10, 20, 30, 50, 40);
        figure = &right_angled_triangle;
        figure->print_info();

        IsoscelesTriangle isosceles_triangle(10, 20, 70, 40);
        ...
        Quadangle quadangle(10, 20, 30, 40, 50, 60, 70, 180);
        figure = &quadangle;
        figure->print_info();
    ...
    catch (const ExceptionFigureCreation& ex) {
